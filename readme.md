...
| 日期 | 提交类型 | 提交说明 | 提交哈希 |
|------|---------|---------|---------|
| 2026-05-13 | fix | 修复CleanEventPage重复函数 & 完善批量生成反追单功能 | 87db86c |
| 2026-05-13 | feat | 批量生成添加反追单功能（参考单条实现） | c244554 |
| 2026-05-13 | feat | 添加批量生成自定义事件时间的反追单功能 | 52a94ae |
| 2026-05-13 | fix | 添加Flask-SQLAlchemy依赖 | 55c7a04 |
| 2026-05-13 | fix | 增强覆盖率报告生成诊断 | 49b264a |
| 2026-05-13 | fix | 移除--no-cov-on-fail参数，确保始终生成覆盖率报告 | 780556a |
| 2026-05-13 | fix | 移除pydantic-core固定版本，让pip自动解决依赖 | 3c14531 |
| 2026-05-13 | fix | 移除distutils依赖（Python 3.12+已集成到setuptools） | 5ef09ee |
| 2026-05-13 | test | 验证所有Python 3.13依赖兼容性（Pillow修复） | c9ae5c3 |
| 2026-05-13 | fix | 升级Pillow支持Python 3.13 | 0186294 |
| 2026-05-13 | fix | 更新requirements-linux.txt以支持Python 3.13 | 8901618 |
| 2026-05-13 | fix | 优化pandas安装策略，强制使用预编译wheel | d5e83c7 |
| 2026-05-13 | fix | 指定pandas 2.2.3确保使用预编译wheel | 4e239ae |
| 2026-05-13 | test | 验证pandas 2.2+预编译wheel安装 | 121c1ee |
| 2026-05-13 | fix | 升级pandas到2.2+以获取Python 3.13预编译wheel | 6fe5656 |
| 2026-05-13 | test | 验证所有Python 3.13依赖兼容性修复 | 5b7a09c |
| 2026-05-13 | fix | 升级lxml支持Python 3.13 | 5ad8b9c |
| 2026-05-13 | fix | 升级pandas支持Python 3.13 | cae9cb1 |
| 2026-05-13 | fix | 修复Python 3.13兼容性问题 | c98aed8 |
| 2026-05-13 | test | 验证lxml系统依赖修复后的CI执行 | bc4270b |
