...
-- 插入示例员工数据
INSERT INTO staff (name, employee_id, department, position, is_active) VALUES
('张三', 'EMP001', '技术部', '工程师', 1),
('李四', 'EMP002', '技术部', '高级工程师', 1),
('王五', 'EMP003', '运维部', '运维工程师', 1),
('赵六', 'EMP004', '运维部', '运维主管', 1);

-- 插入示例节假日配置
INSERT INTO holiday_config (holiday_date, is_working_day, description, wage, after, target, rest) VALUES
('2026-01-01', FALSE, '元旦', 3, FALSE, '元旦', 1),
('2026-02-10', FALSE, '春节', 3, FALSE, '春节', 7),
('2026-02-11', FALSE, '春节', 3, FALSE, '春节', 6),
('2026-02-12', FALSE, '春节', 3, FALSE, '春节', 5),
('2026-02-13', FALSE, '春节', 3, FALSE, '春节', 4),
('2026-02-14', FALSE, '春节', 3, FALSE, '春节', 3),
('2026-02-15', FALSE, '春节', 3, FALSE, '春节', 2),
('2026-02-16', FALSE, '春节', 3, FALSE, '春节', 1),
('2026-04-04', FALSE, '清明节', 3, FALSE, '清明节', 1),
('2026-05-01', FALSE, '劳动节', 3, FALSE, '劳动节', 5),
('2026-05-02', FALSE, '劳动节', 3, FALSE, '劳动节', 4),
('2026-05-03', FALSE, '劳动节', 3, FALSE, '劳动节', 3),
('2026-05-04', FALSE, '劳动节', 3, FALSE, '劳动节', 2),
('2026-05-05', FALSE, '劳动节', 3, FALSE, '劳动节', 1),
('2026-06-25', FALSE, '端午节', 3, FALSE, '端午节', 1),
('2026-10-01', FALSE, '国庆节', 3, FALSE, '国庆节', 7),
('2026-10-02', FALSE, '国庆节', 3, FALSE, '国庆节', 6),
('2026-10-03', FALSE, '国庆节', 3, FALSE, '国庆节', 5),
('2026-10-04', FALSE, '国庆节', 3, FALSE, '国庆节', 4),
('2026-10-05', FALSE, '国庆节', 3, FALSE, '国庆节', 3),
('2026-10-06', FALSE, '国庆节', 3, FALSE, '国庆节', 2),
('2026-10-07', FALSE, '国庆节', 3, FALSE, '国庆节', 1);

-- 插入示例排班数据
INSERT INTO roster (staff_id, shift_date, shift_type, shift_start, shift_end, remark) VALUES
(1, '2026-04-27', '早班', '08:00:00', '16:00:00', NULL),
(2, '2026-04-27', '晚班', '16:00:00', '00:00:00', NULL),
(3, '2026-04-28', '早班', '08:00:00', '16:00:00', NULL),
(4, '2026-04-28', '晚班', '16:00:00', '00:00:00', NULL);

-- 插入示例钉钉推送配置
INSERT INTO dingtalk_schedule_config (webhook_url, time_slots, schedule_times, enabled, description) VALUES
